...
# https://github.com/django-extensions/django-extensions/blob/master/django_extensions/management/commands/clean_pyc.py
BASE_DIR = ROOT_DIR
...
if USE_S3:
    # Force boto3 to look up IAM credentials
...
sentry_sdk.init(
    dsn=SENTRY_DSN,
    release=f'{{cookiecutter.project_slug}}-backend@{VERSION}',
